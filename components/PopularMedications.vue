<template>
  <section
    class="py-16 bg-gray-50 dark:bg-gray-900/50 rounded-3xl px-6 lg:px-12"
  >
    <!-- Section Header -->
    ...
    >
      ...
      >
        <div class="flex items-center gap-4">
          <!-- Icon/Image -->
          <div
            class="w-16 h-16 rounded-xl bg-brand-100 dark:bg-brand-900/30 flex items-center justify-center flex-shrink-0"
          >
  ...
  computed: {
    filteredMedications() {
      ...
      return this.medications.filter(
        (med) => med.category === this.selectedCategory
      )
    },
  },
