        ...
        <div class="grid lg:grid-cols-3 gap-8">
          ...
          <div class="lg:col-span-2">
              ...
              <div class="space-y-6">
                <div class="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <UInput placeholder="نام خانوادگی خود را وارد کنید" size="lg" />
                  </div>
                </div>
                <div>
                  <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  ...
                  <UInput type="email" placeholder="example@email.com" size="lg" />
                </div>
                <div>
                  <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    شماره تلفن
            ...
            <UCard v-if="activeTab === 'orders'">
              ...
              <div class="space-y-4">
                <div v-for="order in orders" :key="order.id" class="border border-gray-200 dark:border-gray-800 rounded-lg p-6">
                  <div class="flex justify-between items-start mb-4">
                    ...
                    <UBadge :color="order.status === 'delivered' ? 'green' : 'blue'">
                      {{ getStatusLabel(order.status) }}
                    </UBadge>
                  </div>
                  <div class="space-y-2 mb-4">
                    <div v-for="item in order.items" :key="item" class="text-sm text-gray-600 dark:text-gray-400">
                      • {{ item }}
                    </div>
                  </div>
                ...
                <UCard v-for="address in addresses" :key="address.id">
                  <div class="flex justify-between items-start">
                    ...
                    <div class="flex gap-2">
                      <UButton size="sm" variant="ghost" icon="i-heroicons-pencil" square />
                      <UButton size="sm" variant="ghost" icon="i-heroicons-trash" color="red" square />
                    </div>
                  </div>
                </UCard>
              </div>
            ...
            <UCard v-if="activeTab === 'prescriptions'">
              ...
              <div class="text-center py-12">
                <UIcon name="i-heroicons-document-text" class="w-20 h-20 text-gray-300 mx-auto mb-4" />
  ...
  data() {
    return {
      ...
      menuItems: [
        ...
        { id: 'prescriptions', label: 'نسخه‌ها', icon: 'i-heroicons-document-text' }
      ],
      orders: [
        {
          id: '۱۰۲۳',
